...
module {
  func.func @main() -> i64 {
    ...
    %s1 = eco.construct(%nil) {tag = 1 : i64, size = 1 : i64} : (!eco.value) -> !eco.value
    %p1 = eco.project %s1[0] : !eco.value -> !eco.value
    eco.dbg %p1 : !eco.value
    // CHECK: []

    %s2 = eco.construct(%true) {tag = 2 : i64, size = 1 : i64} : (!eco.value) -> !eco.value
    %p2 = eco.project %s2[0] : !eco.value -> !eco.value
    eco.dbg %p2 : !eco.value
    // CHECK: True

    %s3 = eco.construct(%false) {tag = 3 : i64, size = 1 : i64} : (!eco.value) -> !eco.value
    %p3 = eco.project %s3[0] : !eco.value -> !eco.value
    eco.dbg %p3 : !eco.value
    // CHECK: False

    %s4 = eco.construct(%unit) {tag = 4 : i64, size = 1 : i64} : (!eco.value) -> !eco.value
    %p4 = eco.project %s4[0] : !eco.value -> !eco.value
    eco.dbg %p4 : !eco.value
    // CHECK: ()

    %s5 = eco.construct(%nothing) {tag = 5 : i64, size = 1 : i64} : (!eco.value) -> !eco.value
    %p5 = eco.project %s5[0] : !eco.value -> !eco.value
    eco.dbg %p5 : !eco.value
    // CHECK: Nothing

    %s6 = eco.construct(%empty_str) {tag = 6 : i64, size = 1 : i64} : (!eco.value) -> !eco.value
    %p6 = eco.project %s6[0] : !eco.value -> !eco.value
    eco.dbg %p6 : !eco.value
    // CHECK: ""

    %s7 = eco.construct(%empty_rec) {tag = 7 : i64, size = 1 : i64} : (!eco.value) -> !eco.value
    %p7 = eco.project %s7[0] : !eco.value -> !eco.value
    ...
    %mix1 = eco.construct(%b42, %nil) {tag = 10 : i64, size = 2 : i64, unboxed_bitmap = 0 : i64} : (!eco.value, !eco.value) -> !eco.value
    eco.dbg %mix1 : !eco.value
    // CHECK: Ctor10 42 []

    %mix1_p0 = eco.project %mix1[0] : !eco.value -> !eco.value
    eco.dbg %mix1_p0 : !eco.value
    // CHECK: 42

    %mix1_p1 = eco.project %mix1[1] : !eco.value -> !eco.value
    ...
    %mix2 = eco.construct(%raw42, %true) {tag = 11 : i64, size = 2 : i64, unboxed_bitmap = 1 : i64} : (i64, !eco.value) -> !eco.value
    eco.dbg %mix2 : !eco.value
    // CHECK: Ctor11 42 True

    %mix2_p0 = eco.project %mix2[0] : !eco.value -> i64
    eco.dbg %mix2_p0 : i64
    // CHECK: 42

    %mix2_p1 = eco.project %mix2[1] : !eco.value -> !eco.value
    ...
    %mix3 = eco.construct(%raw42, %pi, %false) {tag = 12 : i64, size = 3 : i64, unboxed_bitmap = 3 : i64} : (i64, f64, !eco.value) -> !eco.value
    eco.dbg %mix3 : !eco.value
    // CHECK: Ctor12

    %mix3_p2 = eco.project %mix3[2] : !eco.value -> !eco.value
    ...
    %mix4 = eco.construct(%raw42, %nil, %i99) {tag = 13 : i64, size = 3 : i64, unboxed_bitmap = 5 : i64} : (i64, !eco.value, i64) -> !eco.value
    eco.dbg %mix4 : !eco.value
    // CHECK: Ctor13 42 [] 99

    %mix4_p1 = eco.project %mix4[1] : !eco.value -> !eco.value
    ...
    %list1 = eco.construct(%b42, %nil) {tag = 0 : i64, size = 2 : i64, unboxed_bitmap = 0 : i64} : (!eco.value, !eco.value) -> !eco.value
    ...
    %l2 = eco.construct(%b2, %nil) {tag = 0 : i64, size = 2 : i64, unboxed_bitmap = 0 : i64} : (!eco.value, !eco.value) -> !eco.value
    %l1 = eco.construct(%b1, %l2) {tag = 0 : i64, size = 2 : i64, unboxed_bitmap = 0 : i64} : (!eco.value, !eco.value) -> !eco.value
    eco.dbg %l1 : !eco.value
    // CHECK: [1, 2]

    // === Test structure containing only constants ===
    %all_consts = eco.construct(%nil, %true, %false) {tag = 20 : i64, size = 3 : i64} : (!eco.value, !eco.value, !eco.value) -> !eco.value
