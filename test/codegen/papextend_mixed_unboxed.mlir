...
//
// Test papExtend with a mix of boxed and unboxed new arguments.
// This tests the unboxed bitmap handling in papExtend.

module {
  // Function that takes 3 boxed args and returns their sum
  llvm.func @sum3_eval(%args: !llvm.ptr) -> i64 {
    ...
    %boxed = llvm.call @eco_alloc_int(%sum) : (i64) -> i64
