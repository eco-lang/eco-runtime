...
//
// Note: Testing NaN via comparison doesn't work because eco.float.{lt,le,gt,ge,eq,ne}
...
module {
  func.func @main() -> i64 {
    ...
    %min_eq_one = eco.float.eq %min_one_nan, %c1 : f64
    ...
    %max_eq_five = eco.float.eq %max_five_nan, %c5 : f64
    ...
    %min2_eq_one = eco.float.eq %min_nan_one, %c1 : f64
