...
module {
  func.func @main() -> i64 {
    ...
    %is_five = eco.float.cmp eq %min1, %five : f64
    ...
    %is_ten = eco.float.cmp eq %max1, %ten : f64
    ...
    %min_is_five = eco.float.cmp eq %min_nan_first, %five : f64
    ...
    %min_is_five2 = eco.float.cmp eq %min_nan_second, %five : f64
    ...
    %max_is_five = eco.float.cmp eq %max_nan_first, %five : f64
    ...
    %max_is_five2 = eco.float.cmp eq %max_nan_second, %five : f64
    ...
    %min_is_nan = eco.float.cmp eq %min_nan_nan, %min_nan_nan : f64
    ...
    %max_is_nan = eco.float.cmp eq %max_nan_nan, %max_nan_nan : f64
