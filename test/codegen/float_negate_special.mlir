...
module {
  func.func @main() -> i64 {
    ...
    %eq1 = eco.float.cmp eq %neg5, %expected_n5 : f64
    ...
    %eq2 = eco.float.cmp eq %neg_neg3, %expected_3 : f64
    ...
    %is_pos_inf = eco.float.cmp gt %div_pos_zero, %million : f64
    ...
    %is_very_neg = eco.float.cmp lt %neg_inf, %neg_million : f64
    ...
    %is_very_pos = eco.float.cmp gt %pos_inf2, %million : f64
    ...
    %nan_eq = eco.float.cmp eq %neg_nan, %neg_nan : f64
