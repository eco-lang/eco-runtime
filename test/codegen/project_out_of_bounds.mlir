...
module {
  func.func @main() -> i64 {
    ...
    // Project field 1
    %f1 = eco.project.custom %ctor5[1] : !eco.value -> !eco.value
    eco.dbg %f1 : !eco.value
    // CHECK: [eco.dbg] 2

    // Project field 2 (middle)
    %f2 = eco.project.custom %ctor5[2] : !eco.value -> !eco.value
    eco.dbg %f2 : !eco.value
    // CHECK: [eco.dbg] 3

    // Project field 3
    %f3 = eco.project.custom %ctor5[3] : !eco.value -> !eco.value
    eco.dbg %f3 : !eco.value
    // CHECK: [eco.dbg] 4

    // Project field 4 (last)
    %f4 = eco.project.custom %ctor5[4] : !eco.value -> !eco.value
