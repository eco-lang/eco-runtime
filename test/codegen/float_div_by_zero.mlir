...
module {
  func.func @main() -> i64 {
    ...
    %is_huge = eco.float.gt %pos_inf, %million : f64
    ...
    %is_neg_huge = eco.float.lt %neg_inf, %neg_million : f64
    ...
    %is_nan = eco.float.eq %nan, %nan : f64
    ...
    %is_huge2 = eco.float.gt %pos_inf2, %million : f64
    ...
    %is_inf = eco.float.eq %inf_sum, %pos_inf : f64
    ...
    %inf_diff_is_nan = eco.float.eq %inf_diff, %inf_diff : f64
