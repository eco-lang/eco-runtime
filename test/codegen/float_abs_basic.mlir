...
module {
  func.func @main() -> i64 {
    ...
    %huge = eco.float.gt %abs5, %million : f64
    ...
    %huge2 = eco.float.gt %abs6, %million : f64
    ...
    %nan_eq = eco.float.eq %abs7, %abs7 : f64
