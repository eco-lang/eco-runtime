...
module {
  func.func @main() -> i64 {
    ...
    %is_one = eco.float.cmp eq %pow_0_0, %one : f64
    ...
    %is_one2 = eco.float.cmp eq %pow_2_0, %one : f64
    ...
    %is_one3 = eco.float.cmp eq %pow_1_10, %one : f64
    ...
    %sqrt2_ok_lower = eco.float.cmp gt %sqrt2, %sqrt2_lower : f64
    %sqrt2_ok_upper = eco.float.cmp lt %sqrt2, %sqrt2_upper : f64
    ...
    %is_four = eco.float.cmp eq %pow_neg2_2, %four : f64
    ...
    %is_nan = eco.float.cmp eq %pow_neg2_half, %pow_neg2_half : f64
    ...
    %inf_pow_is_one = eco.float.cmp eq %pow_inf_0, %one : f64
    ...
    %is_half = eco.float.cmp eq %pow_2_neg1, %half : f64
