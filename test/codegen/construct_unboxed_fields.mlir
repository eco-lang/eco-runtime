...
module {
  func.func @main() -> i64 {
    ...
    %cons_int = eco.construct(%i42, %nil) {tag = 0 : i64, size = 2 : i64, unboxed_bitmap = 1 : i64} : (i64, !eco.value) -> !eco.value
    ...
    %l3 = eco.construct(%i3, %nil) {tag = 0 : i64, size = 2 : i64, unboxed_bitmap = 1 : i64} : (i64, !eco.value) -> !eco.value
    %l2 = eco.construct(%i2, %l3) {tag = 0 : i64, size = 2 : i64, unboxed_bitmap = 1 : i64} : (i64, !eco.value) -> !eco.value
    %list_ints = eco.construct(%i1, %l2) {tag = 0 : i64, size = 2 : i64, unboxed_bitmap = 1 : i64} : (i64, !eco.value) -> !eco.value
    ...
    %pair_ints = eco.construct(%i10, %i20) {tag = 10 : i64, size = 2 : i64, unboxed_bitmap = 3 : i64} : (i64, i64) -> !eco.value
    eco.dbg %pair_ints : !eco.value
    // CHECK: Ctor10 10 20

    // Project unboxed fields
    %first = eco.project %pair_ints[0] : !eco.value -> i64
    eco.dbg %first : i64
    // CHECK: 10

    %second = eco.project %pair_ints[1] : !eco.value -> i64
    eco.dbg %second : i64
    // CHECK: 20
    ...
    %triple_ints = eco.construct(%i100, %i200, %i300) {tag = 11 : i64, size = 3 : i64, unboxed_bitmap = 7 : i64} : (i64, i64, i64) -> !eco.value
    eco.dbg %triple_ints : !eco.value
    // CHECK: Ctor11 100 200 300

    // Project middle unboxed field
    %middle = eco.project %triple_ints[1] : !eco.value -> i64
    eco.dbg %middle : i64
    // CHECK: 200
    ...
    %mixed = eco.construct(%b42, %i99) {tag = 5 : i64, size = 2 : i64, unboxed_bitmap = 2 : i64} : (!eco.value, i64) -> !eco.value
    eco.dbg %mixed : !eco.value
    // CHECK: Ctor5 42 99

    // Project the unboxed field
    %unboxed_field = eco.project %mixed[1] : !eco.value -> i64
    ...
    %pair_floats = eco.construct(%f1, %f2) {tag = 1 : i64, size = 2 : i64, unboxed_bitmap = 3 : i64} : (f64, f64) -> !eco.value
    eco.dbg %pair_floats : !eco.value
    // CHECK: Ctor1 4614253070214989087 4613302810693613912

    // Project unboxed float
    %float_field = eco.project %pair_floats[0] : !eco.value -> f64
    ...
    %cons_neg = eco.construct(%ineg, %nil) {tag = 0 : i64, size = 2 : i64, unboxed_bitmap = 1 : i64} : (i64, !eco.value) -> !eco.value
