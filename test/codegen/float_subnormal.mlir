...
module {
  func.func @main() -> i64 {
    ...
    %is_pos = eco.float.cmp gt %small, %zero_f : f64
    ...
    %is_larger = eco.float.cmp gt %doubled, %small : f64
    ...
    %eq_doubled = eco.float.cmp eq %sum, %doubled : f64
    ...
    %is_zero = eco.float.cmp eq %diff, %zero_f : f64
