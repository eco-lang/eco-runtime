...
module {
  ...
  llvm.func @sum6_eval(%args: !llvm.ptr) -> !llvm.ptr {
    ...
    %v4_ptr = llvm.inttoptr %v4_i64 : i64 to !llvm.ptr
    ...
    %v5_ptr = llvm.inttoptr %v5_i64 : i64 to !llvm.ptr
    ...
    %boxed = llvm.call @eco_alloc_int(%total) : (i64) -> !llvm.ptr
