...
module {
  func.func @main() -> i64 {
    ...
    %ctor = eco.construct(%int_val, %float_val, %char_val, %boxed_val) {tag = 0 : i64, size = 4 : i64, unboxed_bitmap = 7 : i64} : (i64, f64, i32, !eco.value) -> !eco.value
    ...
    %p2 = eco.project %ctor[2] : !eco.value -> i32
    eco.dbg %p2 : i32
    // CHECK: [eco.dbg] 'A'
