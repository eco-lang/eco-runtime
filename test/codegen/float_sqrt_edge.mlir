...
module {
  func.func @main() -> i64 {
    ...
    %is_zero = eco.float.eq %sqrt_zero, %zero_f : f64
    ...
    %is_one = eco.float.eq %sqrt_one, %one : f64
    ...
    %is_two = eco.float.eq %sqrt_four, %two : f64
    ...
    %eq_self2 = eco.float.eq %sqrt_neg4, %sqrt_neg4 : f64
    ...
    %is_inf = eco.float.eq %sqrt_inf, %inf : f64
