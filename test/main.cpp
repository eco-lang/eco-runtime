...
Testing::TestSuite createTestSuite() {
    Testing::TestSuite suite;

    // Test 1: GC preserves reachable objects
    suite.add(Testing::Test("GC preserves all reachable objects from roots", []() {
    ...
    suite.add(Testing::Test("GC collects unreachable objects", []() {
    ...
    suite.add(Testing::Test("Multiple GC cycles preserve roots correctly", []() {
...
int main(int argc, char* argv[]) {
    ...
    // Create test suite
    Testing::TestSuite suite = createTestSuite();
