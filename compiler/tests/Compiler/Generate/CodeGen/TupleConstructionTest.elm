module Compiler.Generate.CodeGen.TupleConstructionTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_017: Tuple Construction"
        [ expectSuite expectTupleConstruction "passes tuple construction invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Tuple construction invariant " ++ condStr)
