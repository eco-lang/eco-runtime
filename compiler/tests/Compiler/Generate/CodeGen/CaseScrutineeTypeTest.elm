module Compiler.Generate.CodeGen.CaseScrutineeTypeTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_037: Case Scrutinee Type Agreement"
        [ expectSuite expectCaseScrutineeType "passes case scrutinee type invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Case scrutinee type invariant " ++ condStr)
