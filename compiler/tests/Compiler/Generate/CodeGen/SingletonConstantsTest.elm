module Compiler.Generate.CodeGen.SingletonConstantsTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_019: Singleton Constants"
        [ expectSuite expectSingletonConstants "passes singleton constants invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Singleton constants invariant " ++ condStr)
