module Compiler.Generate.CodeGen.CaseKindScrutineeTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_043: Case Kind Scrutinee Type Agreement"
        [ expectSuite expectCaseKindScrutinee "passes case kind scrutinee invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Case kind scrutinee invariant " ++ condStr)
