module Compiler.Generate.CodeGen.JumpTargetTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_030: Jump Target Validity"
        [ expectSuite expectJumpTarget "passes jump target invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Jump target invariant " ++ condStr)
