module Compiler.Generate.CodeGen.RecordConstructionTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_018: Record Construction"
        [ expectSuite expectRecordConstruction "passes record construction invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Record construction invariant " ++ condStr)
