module Compiler.Generate.CodeGen.ListConstructionTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_016: List Construction"
        [ expectSuite expectListConstruction "passes list construction invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("List construction invariant " ++ condStr)
