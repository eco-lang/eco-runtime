module Compiler.Generate.CodeGen.PapCreateArityTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_033: PapCreate Arity Constraints"
        [ expectSuite expectPapCreateArity "passes papCreate arity invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("PapCreate arity invariant " ++ condStr)
