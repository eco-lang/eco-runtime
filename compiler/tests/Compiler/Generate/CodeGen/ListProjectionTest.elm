module Compiler.Generate.CodeGen.ListProjectionTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_021: List Projection"
        [ expectSuite expectListProjection "passes list projection invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("List projection invariant " ++ condStr)
