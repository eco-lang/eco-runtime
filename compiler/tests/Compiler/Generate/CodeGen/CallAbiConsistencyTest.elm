module Compiler.Generate.CodeGen.CallAbiConsistencyTest exposing (suite)
...
import Compiler.Generate.CodeGen.CallAbiConsistency exposing (expectCallAbiConsistency)
