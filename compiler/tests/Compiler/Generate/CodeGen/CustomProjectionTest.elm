module Compiler.Generate.CodeGen.CustomProjectionTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_024: Custom ADT Projection"
        [ expectSuite expectCustomProjection "passes custom projection invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Custom projection invariant " ++ condStr)
