module Compiler.Generate.CodeGen.RecordProjectionTest exposing (suite, expectSuite)
...
import Compiler.Generate.CodeGen.RecordProjection exposing (expectRecordProjection)
...
suite =
    Test.describe "CGEN_023: Record Projection"
        [ expectSuite expectRecordProjection "passes record projection invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Record projection invariant " ++ condStr)
