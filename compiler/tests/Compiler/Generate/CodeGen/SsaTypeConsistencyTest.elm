module Compiler.Generate.CodeGen.SsaTypeConsistencyTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_0B1: SSA Type Consistency"
        [ expectSuite expectSsaTypeConsistency "passes SSA type consistency invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("SSA type consistency invariant " ++ condStr)
