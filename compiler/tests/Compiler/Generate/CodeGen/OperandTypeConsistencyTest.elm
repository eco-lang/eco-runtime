module Compiler.Generate.CodeGen.OperandTypeConsistencyTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_040: Operand Type Consistency"
        [ expectSuite expectOperandTypeConsistency "passes operand type consistency invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Operand type consistency invariant " ++ condStr)
