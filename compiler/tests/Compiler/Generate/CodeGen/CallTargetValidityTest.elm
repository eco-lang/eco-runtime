module Compiler.Generate.CodeGen.CallTargetValidityTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_044: Call Target Validity"
        [ expectSuite expectCallTargetValidity "passes call target validity invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Call target validity invariant " ++ condStr)
