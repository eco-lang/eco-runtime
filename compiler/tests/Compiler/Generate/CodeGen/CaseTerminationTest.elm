module Compiler.Generate.CodeGen.CaseTerminationTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_028: Case Alternative Termination"
        [ expectSuite expectCaseTermination "passes case termination invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Case termination invariant " ++ condStr)
