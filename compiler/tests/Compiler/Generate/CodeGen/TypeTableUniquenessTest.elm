module Compiler.Generate.CodeGen.TypeTableUniquenessTest exposing (suite, expectSuite)
...
suite =
    Test.describe "CGEN_035: Type Table Uniqueness"
        [ expectSuite expectTypeTableUniqueness "passes type table uniqueness invariant"
        ]


expectSuite : (Src.Module -> Expectation) -> String -> Test
expectSuite expectFn condStr =
    Test.describe ("Type table uniqueness invariant " ++ condStr)
