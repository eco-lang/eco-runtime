...
checkExpr env context expr =
    ...
    case expr of
        ...
        -- VarLocal (STRICT: catches MONO_018-class bugs)
        ...
        -- VarKernel (STRICT: catches MONO_018-class bugs)
...
-- ============================================================================
-- DECIDER CHECKING (Critical for MONO_018)
-- ============================================================================
        ...
        TOpt.Inline expr ->
            let
                exprType =
                    TOpt.typeOf expr
            in
            -- STRICT: catches MONO_018-class bugs where branch has polymorphic remnant
