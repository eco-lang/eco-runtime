...
6. Produce a details analysis report on the test failure. IMPORTANT: include actual code trace evidence from the code in the report.
...
Do not fix yet.
IMPORTANT: After step 6, you MUST STOP and report back to the user. DO NOT continue with other ongoing tasks.
